...
data1 <- read.csv("./FFD_PBAs.csv",header = T,check.names = F)
...
data1 <- read.csv("./FFD_SBAs.csv",header = T,check.names = F)
colnames(data1)[1] <- "Group"
data1$Group <- factor(data1$Group,
                      levels = c("Control","DSS","P.goldsteinii"),
                      labels = c("Control","DSS","DSS+Pg"))
...
####
data1 <- read.csv("./FFD_SBAs-to-PBAs.csv",header = T,check.names = F)
colnames(data1)[1] <- "Group"
data1$Group <- factor(data1$Group,
                      levels = c("Control","DSS","P.goldsteinii"),
                      labels = c("Control","DSS","DSS+Pg"))
...
p
ggsave("FFD_SBAs&PBAs.pdf",p,width = 8,height = 4)
